...
kubectl create secret --namespace=kube-system generic hpa-tls-certs --from-file=caKey.pem --from-file=caCert.pem --from-file=serverKey.pem --from-file=serverCert.pem
